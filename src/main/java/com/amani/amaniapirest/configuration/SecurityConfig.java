    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/api/rag/upload").permitAll() // Endpoint para que el psicólogo vea su agenda mensual
                                .requestMatchers("/api/rag/documents/*").permitAll() // Endpoint para que el psicólogo vea su agenda mensual
                                .requestMatchers("/api/rag/documents").permitAll() // Endpoint para que el psicólogo vea su agenda mensual
