...
/**
 * Controlador REST de administración para consultar entradas del diario emocional.
 *
...
public class DiarioEmocionAdminController {
     ...
     */
    @Operation(summary = "Obtener entrada de diario", description = "Obtiene los detalles de una entrada del diario emocional por su ID")
    @ApiResponses(value = {
