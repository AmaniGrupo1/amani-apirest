 ...
 *
 * <p>Permite crear, consultar, actualizar y eliminar direcciones, validando
 * la existencia del paciente referenciado en cada operación.</p>
 */
@Service
public class DireccionService {
    ...
    private DireccionResponseDTO toResponse(Direccion direccion) {
        return new DireccionResponseDTO(
                ...
                direccion.getPaciente() != null ? direccion.getPaciente().getIdPaciente() : null,
                direccion.getCalle(),
                direccion.getCiudad(),
