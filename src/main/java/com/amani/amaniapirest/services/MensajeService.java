...
import com.amani.amaniapirest.dto.request.MensajeRequestDTO;
import com.amani.amaniapirest.dto.response.MensajeResponseDTO;
...
public class MensajeService {
    ...
    public MensajeResponseDTO create(MensajeRequestDTO request) {
        ...
        mensaje.setIdCita(request.getIdCita());
    ...
    private MensajeResponseDTO toResponse(Mensaje mensaje) {
        return new MensajeResponseDTO(
                ...
                mensaje.getSender() != null ? mensaje.getSender().getIdUsuario() : null,
                mensaje.getReceiver() != null ? mensaje.getReceiver().getIdUsuario() : null,
                mensaje.getMensaje(),
                mensaje.getIdCita(),
